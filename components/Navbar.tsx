...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 z-40 bg-surface-50/80 dark:bg-surface-900/80 backdrop-blur-xl border-b border-surface-200/50 dark:border-surface-800/50">
